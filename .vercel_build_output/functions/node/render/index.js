      ...
      signUpWithEmail(email, password, options2 = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const session2 = Object.assign({}, data);
    ...
    var GoTrueClient = class {
      constructor(options2) {
        ...
        if (settings.detectSessionInUrl && (0, helpers_1.isBrowser)() && !!(0, helpers_1.getParameterByName)("access_token")) {
          this.getSessionFromUrl({ storeSession: true }).then(({ error: error3 }) => {
            if (error3) {
              console.error("Error getting session from URL.", error3);
            }
          });
        }
      }
      signUp({ email, password, phone }, options2 = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            this._removeSession();
            const { data, error: error3 } = phone && password ? yield this.api.signUpWithPhone(phone, password, {
              data: options2.data
        ...
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            if (email && !password) {
              ...
              return { user: null, session: null, error: error3 };
            }
            if (email && password) {
      ...
      _listenForMultiTabEvents() {
        ...
        try {
          ...
          console.error("_listenForMultiTabEvents", error3);
        }
      }
    };
  ...
  "node_modules/@supabase/realtime-js/dist/main/RealtimeClient.js"(exports) {
    ...
    var RealtimeClient = class {
      ...
      setAuth(token) {
        ...
        try {
          this.channels.forEach((channel) => channel.joinedOnce && channel.isJoined() && channel.push(constants_1.CHANNEL_EVENTS.access_token, {
            access_token: token
          }));
        } catch (error3) {
          console.log("error", error3);
...
// .svelte-kit/output/server/chunks/db-9f0dd138.js
var import_supabase_js, supabase;
var init_db_9f0dd138 = __esm({
  ".svelte-kit/output/server/chunks/db-9f0dd138.js"() {
    init_shims();
    import_supabase_js = __toModule(require_main5());
    supabase = (0, import_supabase_js.createClient)({}.VITE_SUPABASE_URL, {}.VITE_SUPABASE_ANON_KEY);
  }
});

// .svelte-kit/output/server/chunks/__layout-196fc7ca.js
var layout_196fc7ca_exports = {};
__export(layout_196fc7ca_exports, {
  default: () => _layout
});
var Navbar, getStores, page, error, session, _layout;
var init_layout_196fc7ca = __esm({
  ".svelte-kit/output/server/chunks/__layout-196fc7ca.js"() {
    init_shims();
    init_app_c5b590ec();
    init_db_9f0dd138();
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<nav class="${"navbar navbar-expand-lg navbar-dark bg-danger"}"><div class="${"container-fluid"}"><a class="${"navbar-brand"}" href="${"/"}"><b>My Mood Tracker \u{1F642}</b></a></div></nav>`;
    });
    getStores = () => {
...
// .svelte-kit/output/server/chunks/error-6b82b414.js
var error_6b82b414_exports = {};
__export(error_6b82b414_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/index-ff407fd6.js
var index_ff407fd6_exports = {};
__export(index_ff407fd6_exports, {
  default: () => Routes
});
var Greeting, Entry, EntryModal, Routes;
var init_index_ff407fd6 = __esm({
  ".svelte-kit/output/server/chunks/index-ff407fd6.js"() {
    init_shims();
    init_app_c5b590ec();
    init_db_9f0dd138();
    Greeting = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<p class="${"placeholder-wave"}"><span class="${"placeholder col-12"}"></span></p>
  
<section class="${"container px-4 pt-3 text-center"}"><h1>Welcome</h1>
    <p>How are you feeling today?</p>
    <p>\u{1F60A} \u2639 \u{1F624} \u{1F917} \u{1F62D}</p></section>`;
    });
    Entry = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { date } = $$props;
      let { mood } = $$props;
      let { comment } = $$props;
      if ($$props.date === void 0 && $$bindings.date && date !== void 0)
        $$bindings.date(date);
      if ($$props.mood === void 0 && $$bindings.mood && mood !== void 0)
        $$bindings.mood(mood);
      if ($$props.comment === void 0 && $$bindings.comment && comment !== void 0)
        $$bindings.comment(comment);
      return `<button type="${"button"}" class="${"list-group-item list-group-item-action"}"><div class="${"d-flex w-100 justify-content-between lh-1"}"><h6 class="${"my-0"}">${escape(date)}</h6>

   	 ${mood === "Worst" ? `<span class="${"text-danger"}">${escape(mood)}</span>` : `${mood === "Bad" ? `<span class="${"text-warning"}">${escape(mood)}</span>` : `${mood === "Okay" ? `<span class="${"text-primary"}">${escape(mood)}</span>` : `${mood === "Good" ? `<span class="${"text-info"}">${escape(mood)}</span>` : `${mood === "Best" ? `<span class="${"text-success"}">${escape(mood)}</span>` : ``}`}`}`}`}</div>
	
		<small class="${"text-muted"}">${escape(comment)}</small></button>`;
    });
    EntryModal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let emoji = "\u{1F610}";
      let day = "1";
      let month = "1";
      let year = "2021";
      let comment = "This is a comment";
      return `<div class="${"modal fade"}" id="${"newEntry"}" tabindex="${"-1"}"><div class="${"modal-dialog modal-dialog-centered modal-dialog-scrollable"}"><div class="${"modal-content"}"><div class="${"modal-header"}"><h5 class="${"modal-title"}">New Entry</h5>
   			 <button type="${"button"}" class="${"btn-close"}" data-bs-dismiss="${"modal"}" aria-label="${"Close"}"></button></div>
   		 <div class="${"modal-body"}">
   			 <div class="${"row"}"><div class="${"col"}"><form class="${"form-floating"}"><input type="${"number"}" class="${"form-control"}" id="${"dayInput"}" min="${"1"}" max="${"31"}"${add_attribute("value", day, 0)}>
   						 <label for="${"dayInput"}">Day</label></form></div>
   				 <div class="${"col"}"><form class="${"form-floating"}"><input type="${"number"}" class="${"form-control"}" id="${"monthInput"}" min="${"1"}" max="${"12"}"${add_attribute("value", month, 0)}>
   						 <label for="${"monthInput"}">Month</label></form></div>
   				 <div class="${"col"}"><form class="${"form-floating"}"><input type="${"number"}" class="${"form-control"}" id="${"yearInput"}" min="${"2021"}"${add_attribute("value", year, 0)}>
   						 <label for="${"yearInput"}">Year</label></form></div></div>

   			 
   			 <div class="${"row mt-3 text-center"}"><h5>How was your day?</h5>
   				 <h1 class="${"display-1"}">${escape(emoji)}</h1></div>
   			 <div class="${"row px-5"}"><div class="${"btn-group mt-2 mb-3"}" role="${"group"}"><input type="${"radio"}" class="${"btn-check"}" name="${"moodRadio"}" id="${"worst"}" autocomplete="${"off"}">
   					 <label class="${"btn btn-outline-danger"}" for="${"worst"}">Worst</label>

   					 <input type="${"radio"}" class="${"btn-check"}" name="${"moodRadio"}" id="${"bad"}" autocomplete="${"off"}">
   					 <label class="${"btn btn-outline-warning"}" for="${"bad"}">Bad</label>

   					 <input type="${"radio"}" class="${"btn-check"}" name="${"moodRadio"}" id="${"okay"}" autocomplete="${"off"}" checked>
   					 <label class="${"btn btn-outline-primary"}" for="${"okay"}">Okay</label>

   					 <input type="${"radio"}" class="${"btn-check"}" name="${"moodRadio"}" id="${"good"}" autocomplete="${"off"}">
   					 <label class="${"btn btn-outline-info"}" for="${"good"}">Good</label>

   					 <input type="${"radio"}" class="${"btn-check"}" name="${"moodRadio"}" id="${"best"}" autocomplete="${"off"}">
   					 <label class="${"btn btn-outline-success"}" for="${"best"}">Best</label></div></div>

   			 
   			 <div class="${"form-floating"}"><textarea class="${"form-control"}" placeholder="${"Leave a comment here"}" id="${"comment"}">${comment}</textarea>
   				 <label for="${"commentTextarea"}">Comments</label></div></div>
   		 <div class="${"modal-footer"}"><button type="${"button"}" class="${"btn btn-secondary"}" data-bs-dismiss="${"modal"}">Cancel</button>
   			 <button type="${"button"}" class="${"btn btn-primary"}">Add</button></div></div></div></div>`;
    });
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      async function getEntries() {
        const { data, error: error3 } = await supabase.from("moodEntries").select();
        if (error3)
...
<section class="${"container px-4 py-3"}"><div class="${"d-flex justify-content-between"}"><div class="${"p-2"}">Mood Log</div>
   	 <input class="${"btn btn-light mb-2"}" type="${"button"}" value="${"+ New Entry"}" data-bs-toggle="${"modal"}" data-bs-target="${"#newEntry"}"></div>
...
`;
        ...
        return function(data) {
          return `
${each(data, (entry) => `${validate_component(Entry, "Entry").$$render($$result, {
...
`;
      ...
      }(getEntries())}</div></section>


<section class="${"container px-4 py-3 text-center"}"><button class="${"btn btn-secondary"}">Logout</button></section>
...
// .svelte-kit/output/server/chunks/login-1f321d09.js
var login_1f321d09_exports = {};
__export(login_1f321d09_exports, {
  default: () => Login
});
var Login;
var init_login_1f321d09 = __esm({
  ".svelte-kit/output/server/chunks/login-1f321d09.js"() {
    init_shims();
    init_app_c5b590ec();
    init_db_9f0dd138();
    Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let email;
      return `<div class="${"card mt-5 m-auto text-center"}" style="${"width: 24em;"}"><div class="${"card-body"}"><h5 class="${"card-title"}">Welcome</h5>
   	 <p class="${"card-text text-muted"}">Please log-in to continue...</p>
   	 <form class="${"form-floating"}"><input class="${"form-control"}" type="${"email"}"${add_attribute("value", email, 0)}>
   		 <label for="${"floatingInput"}">Email address</label>
   		 <button type="${"submit"}" class="${"btn btn-dark mt-3"}">Magic</button></form></div></div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/app-c5b590ec.js
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-6c861512.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-6c861512.js", assets + "/_app/chunks/vendor-9fc60af8.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
${``}`;
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_196fc7ca(), layout_196fc7ca_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_6b82b414(), error_6b82b414_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_ff407fd6(), index_ff407fd6_exports)),
      "src/routes/login.svelte": () => Promise.resolve().then(() => (init_login_1f321d09(), login_1f321d09_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-850cdca1.js", "css": [], "js": ["pages/__layout.svelte-850cdca1.js", "chunks/vendor-9fc60af8.js", "chunks/db-e17905c6.js", "chunks/singletons-12a22614.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-ea945fae.js", "css": [], "js": ["error.svelte-ea945fae.js", "chunks/vendor-9fc60af8.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-b641feca.js", "css": [], "js": ["pages/index.svelte-b641feca.js", "chunks/vendor-9fc60af8.js", "chunks/db-e17905c6.js"], "styles": [] }, "src/routes/login.svelte": { "entry": "pages/login.svelte-58460f9f.js", "css": [], "js": ["pages/login.svelte-58460f9f.js", "chunks/vendor-9fc60af8.js", "chunks/db-e17905c6.js"], "styles": [] } };
  }
});
